...
class ReturnsListSerializer(serializers.ListSerializer):
    def create(self, validated_data):
        print(f'validated data = {validated_data}')
        print(f'Type of validated_data: {type(validated_data)}')
        for item in validated_data:
        ...
        try:
            created_returns = Returns.process_return(validated_data)
...
class ReturnsSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        list_serializer_class = ReturnsListSerializer
